...
const Footer = () => {
    return (
        <footer>
            ...
            <div className='logo_and_contacts'>
            ...
            <div className='footer_categories'>
                <ul>
                    <li className='name_categories_footer'>Репродукции</li>
                    <li className='categories_footer'>Франция</li>
                    <li className='categories_footer'>Германия</li>
                    <li className='categories_footer'>Англия</li>
                </ul>
                <ul>
                    <li className='name_categories_footer'>Новинки</li>
                    <li className='categories_footer'>2021</li>
                    <li className='categories_footer'>2020</li>
                </ul>
                <ul>
                    <li className='name_categories_footer'>О Нас</li>
                    <li className='categories_footer'>Художники</li>
                    <li className='categories_footer'>Менеджеры</li>
                </ul>
            </div>
            <div className='sites_ink'>
