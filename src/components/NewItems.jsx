...
const NewItems = () => {
    return (
        <div className='new_items'>
            <div className='box_newItems'>
            <div className='box_image_titleItems'>
                <svg className='icon_newItem' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 79" fill="none">
                ...
                <h1 className='title_newItem'>Новая коллекция французских авторов</h1>
            </div>
            <div className='description_newItem_box'>
                <h2 className='description_newItem'>Сложно сказать, почему акционеры крупнейших компаний призывают нас к новым свершениям, которые, в свою очередь, должны быть заблокированы в рамках своих собственных рациональных ограничений.</h2>
                <br/>
                <h2 className='description_newItem'>Принимая во внимание показатели успешности, граница обучения кадров предопределяет высокую востребованность направлений прогрессивного развития.</h2>
            </div>
                <button className='btn_newItem'>Ознакомиться</button>
            </div>
        </div>
    );
};
